describe ("when returning exact change", function(){
	...
	it ("should return the string 'Insufficient Funds'", function (){
	...
	it ("should return the string 'Closed'", function(){
	...
	it ("should return correct array of change amount", function (){
